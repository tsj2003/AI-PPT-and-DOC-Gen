...
import { UserPlus, Mail, Lock, User, Eye, EyeOff, Sparkles, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-slate-900 font-sans">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-600/30 rounded-full blur-[120px] animate-pulse delay-1000" />
      </div>
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-8 animate-slide-down">
            <div className="flex justify-center mb-4">
              <img
                src={Logo}
                alt="AI DocGen Logo"
                className="w-20 h-20 object-contain drop-shadow-[0_0_15px_rgba(168,85,247,0.5)] hover:scale-105 transition-transform duration-300"
              />
            </div>
            <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-gray-400 mb-2">
              AI DocGen
            </h1>
            <p className="text-gray-400 text-sm max-w-xs mx-auto">
              Create stunning presentations and documents in seconds with generic AI.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="group animate-slide-up" style={{ animationDelay: '0.1s' }}>
              <label className="block text-xs font-medium text-gray-400 mb-1 ml-1 group-focus-within:text-purple-400 transition-colors">
                USERNAME
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent focus:bg-white/10 transition-all duration-300"
                  placeholder="johndoe"
                  required
                />
              </div>
            ...
            <div className="group animate-slide-up" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full pl-10 pr-10 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent focus:bg-white/10 transition-all duration-300"
                  placeholder="••••••••"
                  required
                  minLength="6"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative group overflow-hidden rounded-xl p-[1px] focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-900 animate-slide-up"
          ...
          <div className="mt-8 text-center animate-slide-up" style={{ animationDelay: '0.5s' }}>
            <p className="text-gray-400 text-sm">
              ...
              <Link to="/login" className="text-purple-400 hover:text-purple-300 font-medium transition-colors hover:underline decoration-purple-400/30 underline-offset-4">
                Sign in
              </Link>
            </p>
          </div>
